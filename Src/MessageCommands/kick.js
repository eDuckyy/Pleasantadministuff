...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('kick')
        .setDescription('Removes a specified user from the experience')
        ...
        .addStringOption(option =>
            option.setName('input')
                .setDescription('Username/UserID to kick')
                .setRequired(true))
        ...
        try {
            ...
            if (robloxData.id) {
                ...
                const confirmEmbed = new EmbedBuilder()
                    ...
                    .setDescription(`Are you sure you want to remove **${userToKick}** from the experience?`)
                    .setTimestamp();
                            ...
                            try {
                                ...
                                if (message) {
                                    ...
                                    if (logChan) {
                                        ...
                                        console.log("A log channel was not set, so no log has been sent to the Pleasant Discord, though a kick was executed.");
                                    }
                                } else {
